...
class SendMailSmtpClass {
    ...
    */   
    ...
    public function __construct($smtp_username = 'comixivan@yandex.ru', $smtp_password = 'Qwertyqwerty1', $smtp_host = 'ssl://smtp.yandex.ru', $smtp_from = 'Ivan', $smtp_port = 465, $smtp_charset = "utf-8") {
    ...
    */
    function send($mailTo = 'user', $subject = 'Подтверждение регистрации', $message = 'Подтвердите свою электронную почту. Перейдите по ссылке ', $headers = 'Подтверждение электронной почты') {
